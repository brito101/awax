        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/usuarios/usuario/{$user->id}"); ?>" method="post">
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-warning" data-post="<?= url("/admin/usuarios/usuario/{$user->id}"); ?>" data-action="delete" data-confirm="ATENÇÃO: Tem certeza que deseja excluir o usuário e todos os dados relacionados a ele? Essa ação não pode ser desfeita!" data-user_id="<?= $user->id; ?>">Excluir Usuário</a>
                </div>
            </form>
        </div>
    <?php endif; ?>
