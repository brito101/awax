...
<section class="dash_content_app">
    <?php if (!$category) : ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/categoria"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else : ?>
        <header class="dash_content_app_header">
            ...
            <a class="icon-link btn btn-green" href="<?= url("/blog/em/{$category->uri}"); ?>" target="_blank" title="">Ver no site</a>
        </header>

        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/categoria/{$category->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
