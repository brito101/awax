                ...
                <?php else : ?>
                    ...
                    ?>
                        <article>
                            ...
                            <div class="actions">
                                <a class="icon-pencil btn btn-blue" title="" href="<?= url("/admin/blog/post/{$post->id}"); ?>">Editar</a>

                                <a class="icon-trash-o btn btn-red" title="" href="#" data-post="<?= url("/admin/blog/post"); ?>" data-action="delete" data-confirm="Tem certeza que deseja deletar esse post?" data-post_id="<?= $post->id; ?>">Deletar</a>
                            </div>
                        </article>
                    <?php endforeach; ?>
                <?php endif; ?>
